...
fun InsertMhsView(
    ...
    viewModel: MahasiswaViewModel = viewModel(factory = PenyediaViewModel.Factory)                     //inisialisasi
){
...
@Composable
fun FormMahasiswa(
    mahasiswaEvent: MahasiswaEvent = MahasiswaEvent(),              //didapatkan dari viewmodel, mahasiswa event pengganti var by remember
    onValueChange: (MahasiswaEvent) -> Unit = {},
    ...
    Column(modifier = modifier.fillMaxWidth())
    {
        OutlinedTextField(
            modifier = Modifier.fillMaxWidth(),
            value = mahasiswaEvent.nama,                            //dimasukian datanya dlm sini
            onValueChange = {                                       //mengubah status di tampilan, yg isinya ada dlm kurung
                onValueChange(mahasiswaEvent.copy(nama = it))
            },
            label = { Text("Nama") },
            isError = errorState.nama != null,                      //validasi, eror state didapat dari parameter form error state
            placeholder = { Text("Masukkan Nama") },
        )
        Text(
            text = errorState.nama ?: "",                           // tanda ? artinya boleh kosong
            color = Color.Red
        )
        OutlinedTextField(
            modifier = Modifier.fillMaxWidth(),
